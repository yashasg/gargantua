...
Enforcement follows the Covenant's standard four-tier ladder (Correction → Warning → Temporary Ban → Permanent Ban). See the [full text](https://www.contributor-covenant.org/version/2/1/code_of_conduct/) for details.
